    ...
    try {
      ...
      try {
        ...
        if (userDoc) {
          ...
          // The selected line with types:
          const updatedCertifications: string[] = userDoc.certifications.filter((id: string) => id !== machineId);
      ...
      try {
        ...
        try {
          ...
          if (userDoc) {
            ...
            const updatedCertifications: string[] = (userDoc as UserDocument).certifications.filter((id: string) => id !== "6");
            success = await mongoDbService.updateUser(userId, { certifications: updatedCertifications });
